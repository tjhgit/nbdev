...
def nbdev_clean_nbs(fname:Param("A notebook name or glob to convert", str)=None,
                    ...
                    recursive:Param("Recursive into dirs", bool)=False,
    ...
    files = path.glob('**/*.ipynb') if fname is None else glob.glob(fname, recursive=recursive)
    # print(list(files))
    for f in files:
        ...
        try:
            ...
            print(f'error parsing notebook:{f}. Error {str(e)}. Ignoring ...')
            pass
